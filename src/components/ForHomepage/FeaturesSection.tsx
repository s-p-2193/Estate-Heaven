...
const FeaturesSection: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Chat Ditectly through this application to buyer or seller using our premium feature.',
    },
  ];

  return (
    <section className="features-section">
      <h2 className="features-title">Why Choose Estate Heaven?</h2>
      <p className="features-description">
        Discover the unique features that make Estate Heaven the best platform for property buying, selling, and renting.
      </p>
